...
export const LESSON_STEPS: LessonStep[][] = [
  ...
  [
    ...
    { text: '4. Bảng tổng hợp và đánh giá các nguồn thông tin: Thực hiện đánh giá chi tiết 10 nguồn tài liệu (gồm 5 bài báo khoa học, 2 sách chuyên khảo, 3 báo cáo chuyên ngành), chấm điểm và phân loại khoa học.' },
